...
window.addEventListener('load', () => {
    setTimeout(() => {
        if ($('[parent-animation]').length) {
            const parentAnimation = document.querySelectorAll("[parent-animation]");
        ...
        if ($('[parent-animation-loop]').length) {
            let loop = () => {
                const parentAnimation = document.querySelectorAll("[parent-animation-loop]");
                parentAnimation.forEach((elem, index) => {
                    let moveUpElem = elem.querySelectorAll("[data-move]");
                    let slideElem = elem.querySelectorAll("[data-slide]");
